...
- sound effects (import + programming)
...
- ghost enemy (id 230) (programming) (includes invis)
- hobgoblin enemy (id 194) (drawing + programming) (includes shout effect)
- bat enemy (id 198) (programming) (includes drain)
- wolf enemy (id 196) (drawing + programming) (includes shout effect)
- werewolf enemy (id 196) (drawing + programming + design) 
...
- fire spell and basic spell uses
- sleep spell
- zombie enemy
- banish spell
- heal spell
